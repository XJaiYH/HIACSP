...
class HIACSP():
    ...
    def shrink(self, T):
        ...
        self.influence_norm = self.influence_norm / self.density
...
if __name__=="__main__":
    ...
    k_set = [20] # parameter K
    T_set = [1.] # parameter T

    algo_name = 'HIACSP-KNN'
    data, label = load_data(args)
    # label = reset_label(label)
